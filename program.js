...
program
    ...
    .option('-ctx, --contextseparator [path]', 'Specify keyseparator you want to use, defaults to ##', '')
    .option('-no-ctx, -nocontext', 'no context', false)
...
if (program.source && program.language) {
    var options = {
        ...
        contextseparator: (program.nocontext)? '' : program.contextseparator,
        quiet: program.quiet
    };
